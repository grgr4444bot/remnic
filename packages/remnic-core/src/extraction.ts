...
{
  "facts": [{"category": "decision", "content": "Chose PostgreSQL over MongoDB for the user service", "confidence": 0.9, "tags": ["database", "architecture"], "scope": "project", "structuredAttributes": {"chosen": "PostgreSQL", "rejected": "MongoDB"}}, {"category": "procedure", "content": "When you cut a hotfix release, follow the checklist", "confidence": 0.9, "tags": ["workflow"], "scope": "project", "procedureSteps": [{"order": 1, "intent": "Branch from main and cherry-pick the fix"}, {"order": 2, "intent": "Run CI and tag the release"}]}, {"category": "reasoning_trace", "content": "How I debugged the staging latency spike", "confidence": 0.9, "tags": ["debugging", "performance"], "scope": "project", "reasoningTrace": {"steps": [{"order": 1, "description": "Checked CPU/memory dashboards"}, {"order": 2, "description": "Ran traceroute and saw retries against cache tier"}, {"order": 3, "description": "Tailed cache-tier logs and spotted eviction storms"}], "finalAnswer": "Root cause was an undersized eviction policy on the session cache", "observedOutcome": "Increased cache size, p95 returned to baseline within 10 minutes"}}, {"category": "commitment", "content": "Must ship v2.0 API by end of March", "confidence": 1.0, "tags": ["deadline"], "scope": "project", "structuredAttributes": {"deadline": "end of March", "deliverable": "v2.0 API"}}, {"category": "fact", "content": "The store backend uses Redis for session caching", "confidence": 0.95, "tags": ["infra", "database"], "scope": "project", "entityRef": "project-acme-store"}, {"category": "principle", "content": "Always run migrations in a transaction to avoid partial schema updates", "confidence": 0.9, "tags": ["database", "best-practice"], "scope": "global"}],
